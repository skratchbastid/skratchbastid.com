...
<template>
    <div class="bg-gradient-to-br from-gray-50 from-10% to-blue-50 to-45% min-h-screen">
        <p class="py-12 text-center text-3xl">Hang tight - we're making a few updates...</p>
        <p v-if="isVip">Is VIP?</p>
        <!-- <div v-show="isVip" class="pt-12">
            ...
            <div class="grid grid-cols-2 px-4 md:grid-cols-3 md:w-2/3 lg:w-1/2 m-auto text-center text-xs uppercase gap-4">
                <NuxtLink to="#" class="border bg-white rounded-full p-2 hover:bg-slate-800 hover:text-white">Zoom Room</NuxtLink>
                <NuxtLink to="https://forms.gle/BRCTSjmhkMCMXeXx8" target="_blank" class="border bg-white rounded-full p-2 hover:bg-slate-800 hover:text-white">Guest List</NuxtLink>
                <NuxtLink to="https://forms.gle/J2xqcLFkbszBdHfd7" target="_blank" class="border bg-white rounded-full p-2 hover:bg-slate-800 hover:text-white">Requests + AMA</NuxtLink>
            </div>
        </div>
