            ...
            <div class="my-8 px-2">
                <div v-for="show in futureShowListings" class="flex w-full items-center my-4 bg-white px-6 py-4 border-2 border-black rounded">
                    ...
                    <div class="flex flex-col lg:flex-row flex-grow md:flex-grow-0 w-9/12 items-center justify-center">
                        <div class="font-black uppercase md:w-2/3 md:text-2xl text-center">{{ show.location }}</div>
                    ...
                    <div class="ml-auto w-3/10">
                        <a v-if="show.ticketLink" :href="show.ticketLink" target="_blank" class="uppercase bg-teal-600 text-white text-xs md:text-base px-3 py-3 md:px-5 rounded font-bold">Tickets</a>
                    </div>
                </div>
            </div>
        </div>
