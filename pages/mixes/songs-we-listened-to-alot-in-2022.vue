...
<template>
    ...
    <div class="my-12 py-12 w-2/3 m-auto flex flex-col gap-y-8 px-12 gap-x-12">
        <div class="">
            <h2 class="text-3xl font-extrabold">Bastid and Cosmo talk through their selections on Tuesday Morning Coffee</h2>
        </div>
        <div class="">
            <client-only>
