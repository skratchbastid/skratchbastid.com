    ...
    <div class="mb-6">
        ...
        <section class="py-12 px-4 w-full md:max-w-[85%] m-auto flex flex-col md:flex-row gap-6 md:gap-12">
            ...
            <div class="flex flex-col items-start items-center md:items-start justify-center w-full md:w-1/2">
                ...
                <p class="mb-1 md:mb-2 text-center md:text-left md:text-lg">Bastid and Cosmo Baker are back with another bangin' year end mix chock-full of amazing musical discoveries new and old.</p>
