...
<template>
    <div class="mb-6">
        ...
        <div class="flex flex-col md:flex-row md:gap-6 px-2 md:px-12">
                    ...
                    <div class="absolute inset-0 z-30 flex flex-col">
                        ...
                        <div class="absolute bottom-0 left-0 right-0 z-40 flex justify-center items-end">
                            <div class="bg-gradient-to-t from-black to-transparent py-6 px-4 w-full">
                                <h2 class="text-white text-lg lg:text-xl mb-2"><span class="font-bold">Latest Stream:</span> <span class="font-light">4 days ago</span></h2>
