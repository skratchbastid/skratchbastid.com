...
<template>
    <div class="mx-10 mb-8 p-8">
        <h1 class="text-5xl font-extrabold mb-3 text-center">Join the Top Grillin' VIP Crew</h1>
        <div class="flex items-center justify-center gap-x-12">
            <div class="w-3/12">
                <nuxt-img src="676e1aaa-f866-4d29-51cb-7e1caf664600/public" loading="lazy" />
            </div>
            <div class="flex flex-col">
                <h1 class="text-5xl font-extrabold mb-3 hidden">Join Skratch Bastid's Top Grillin' VIP Crew</h1>
