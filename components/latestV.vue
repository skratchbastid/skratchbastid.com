...
const filteredVideos = computed(() => {
    return [...videos.value] // Crea una copia per evitare modifiche dirette all'array reattivo
      ...
      <div class="flex justify-between items-center pr-4 mb-4">
          <div class="flex items-center gap-2">
              <img 
                  ...
                  class="w-6 h-6"
              />
              <h2 class="text-[18px] font-bold text-gray-800">Latest</h2>
          </div>
          <div @click="setTab('Latest')">
