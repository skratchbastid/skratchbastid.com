...
const filteredVideos = computed(() => {
    // Filtra i video escludendo quelli il cui titolo contiene "Tuesday Morning Coffee" seguito da altre parole
    return videos.value
      ...
      <div class="flex justify-between items-center pr-4 mb-4">
          <div class="flex items-center gap-2">
              <img 
                  ...
                  class="w-6 h-6"
              />
              <h2 class="text-[18px] font-bold text-gray-800">Pop-Up</h2>
          </div>
          <div @click="setTab('Popup')">
